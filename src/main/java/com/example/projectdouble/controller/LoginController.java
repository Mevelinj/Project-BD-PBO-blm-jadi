...
public class LoginController implements Initializable {
    ...
    // @FXML
    // private Label errorMessageLabel; // Dihapus karena tidak ada di FXML baru
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // if (errorMessageLabel != null) { // Menghindari NullPointerException jika Label tidak ada
        //     errorMessageLabel.setText(""); // Mengosongkan pesan error saat awal
        // }
    }
    ...
    private void actionLogin(ActionEvent event) { // Mengubah dari handleLogin ke actionLogin
        ...
        if (loggedInUser != null) {
            ...
            //     errorMessageLabel.setText(""); // Bersihkan pesan error jika login berhasil
            // }
